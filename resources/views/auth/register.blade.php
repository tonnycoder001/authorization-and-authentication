    ...
    <form action="{{route('register')}}" method="post" class="space-y-4">
     ...
     @enderror
      ...
      <div class="flex flex-col">
        ...
        <input type="text" id="username" name="username" class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500"
     ...
     @enderror
      ...
      <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700">Register</button>
    </form>
  </div>
